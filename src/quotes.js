...
(function () {
  var TICKERS = ['AFKS', 'AFLT', 'AGRO', 'AKRN', 'ALRS', 'AMEZ', 'APTK', 'AVAZ', 'AVAZP', 'BANEP', 'BSPB', 'CBOM', 'CHMF', 'CHMK', 'DIXY', 'DSKY', 'ENPL', 'ENRU', 'FEES', 'FESH', 'FTRE', 'GAZP', 'GMKN', 'HYDR', 'IRAO', 'IRGZ', 'KBTK', 'KRKNP', 'LKOH', 'LNTA', 'LNZL', 'LNZLP', 'LSNG', 'LSNGP', 'LSRG', 'MAGN', 'MFGSP', 'MFON', 'MGNT', 'MGTSP', 'MOEX', 'MRKC', 'MRKP', 'MRKU', 'MRKV', 'MRKY', 'MRKZ', 'MSNG', 'MSRS', 'MSTT', 'MTLR', 'MTLRP', 'MTSS', 'MVID', 'NKHP', 'NKNCP', 'NLMK', 'NMTP', 'NVTK', 'OGKB', 'PHOR', 'PIKK', 'PLZL', 'POLY', 'PRTK', 'PSBR', 'QIWI', 'RASP', 'RBCM', 'RNFT', 'ROSN', 'RSTI', 'RSTIP', 'RTKM', 'RTKMP', 'RUAL', 'SBER', 'SBERP', 'SELG', 'SELGP', 'SFIN', 'SNGS', 'SNGSP', 'SVAV', 'TATN', 'TATNP', 'TGKA', 'TGKB', 'TGKD', 'TGKN', 'TRCN', 'TRMK', 'TRNFP', 'UNKL', 'UPRO', 'URKA', 'UWGN', 'VSMO', 'VTBR', 'YNDX', 'KMAZ', 'UNAC'];
